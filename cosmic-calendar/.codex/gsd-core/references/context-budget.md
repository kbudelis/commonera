...
The keys live in `.codex/settings.json` (project) or `/Users/tyler.linahan/Desktop/_Repos/_Clients/CE-CosmicCal/cosmic-calendar/.codex/settings.json` (global) — **not** in `.planning/config.json`:
