...
**Verification depth scales with `asvs_level`** (see @/Users/tyler.linahan/Desktop/_Repos/_Clients/CE-CosmicCal/cosmic-calendar/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
