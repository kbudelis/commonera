...
export const velveteenSectionPacks: VelveteenSectionPack[] = [
  ...
  { sectionId: "maggid", readingPassageIdsByTier: tiers(["vr9-maggid-opening"], ["vr9-maggid-opening", "vr9-maggid-journeys"]), actionPassageIds: [], coverageNote: "The 45/90 tier adds a complete attributed reflection; this pack does not yet encode the full Exodus narrative pages." },
