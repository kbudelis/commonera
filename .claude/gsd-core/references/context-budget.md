...
The keys live in `.claude/settings.json` (project) or `/Users/tyler.linahan/Desktop/_Repos/_Clients/CE-CosmicCal/.claude/settings.json` (global) — **not** in `.planning/config.json`:
