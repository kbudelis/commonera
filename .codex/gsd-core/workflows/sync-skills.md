...
INSTALL_JS_GLOBAL="/Users/tyler.linahan/Desktop/_Repos/_Clients/CE-CosmicCal/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/tyler.linahan/Desktop/_Repos/_Clients/CE-CosmicCal/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
