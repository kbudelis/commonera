...
- **Global scope**: `/Users/tyler.linahan/Desktop/_Repos/_Clients/CE-CosmicCal/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/tyler.linahan/Desktop/_Repos/_Clients/CE-CosmicCal/.codex/notes/`)
...
2. Glob `/Users/tyler.linahan/Desktop/_Repos/_Clients/CE-CosmicCal/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/tyler.linahan/Desktop/_Repos/_Clients/CE-CosmicCal/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/tyler.linahan/Desktop/_Repos/_Clients/CE-CosmicCal/.codex/notes/` — works in any directory
